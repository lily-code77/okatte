                            ...
                            <a href="{{ route('article.show', ['article' => $myArticle->id]) }}">
                                ...
                                <div class="">
                                    ...
                                    <div class="mt-2 flex">
                                        ...
                                        <p class="ml-5 flex"><img src="{{ asset('images/index/favorite.svg') }}" alt="Favorites"> : {{ $myArticle->favorites_count }}</p>
                                    </div>
                            ...
                            <a href="{{ route('recipe.show', ['recipe' => $myRecipe->id]) }}">
                                ...
                                <div class="">
                                    ...
                                    <div class="mt-2 flex">
                                        ...
                                        <p class="ml-5 flex"><img src="{{ asset('images/index/favorite.svg') }}" alt="Favorites"> : {{ $myRecipe->favorites_count }}</p>
                                    </div>
