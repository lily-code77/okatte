...
<section class="container mx-3">
    <form action="{{ route('recipe.update',  ['recipe' => $recipe['id']]) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="flex">
            ...
            <a href="{{ route('mindmap.show', ['recipe' => $recipe['id']]) }}" target="_blank"><button type="button" class="my-3 focus:outline-none button font-medium rounded text-sm px-5 py-2.5">Mind Map</button></a>
        </div>
        <div class="m-3">
